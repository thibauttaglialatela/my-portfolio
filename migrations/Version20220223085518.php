 ...
 */
final class Version20220223085518 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE personnal_content ADD updated_at DATETIME DEFAULT NULL');
    }
